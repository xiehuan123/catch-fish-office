...
const update=()=>{
    ...
    drawText(ctx.value, height.value * 0.25 - x1Width / 2 + 0.017 * height.value, height.value * 0.5 -0.019*height.value, props.name, `${0.13 * rootFontSize.value}px SF-Pro`,'rgba(255, 255, 255, .7)')
