<template>
  ...
  <div class="date-input">
    <input v-model="hours" type="number" min="0" max="23" @input="formatHours" placeholder="00" class="time-input" />
    :
    <input v-model="minutes" type="number" min="0" max="59" @input="formatMinutes" placeholder="00"
      class="time-input" />
  </div>
